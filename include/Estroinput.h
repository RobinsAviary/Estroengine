...
// Some of the functions in this file are defined in the implementation file, but the platform-agnostic ones are in Estroinput.cpp
...
namespace Estro {
    namespace Input {
        ...
        namespace Gamepad {
            ...
            namespace Buttons {
                /*!@ingroup Input
                 * @brief An enum of buttons for use with input functions
                 */
                enum Button {
                    A,
                    B,
