...
The structure/functionality of the engine (and it's sister libraries) is heavily inspired by engines such as [Godot](https://godotengine.org/), [Source](https://developer.valvesoftware.com/wiki/Main_Page), and [GameMaker](https://gamemaker.io/en).
